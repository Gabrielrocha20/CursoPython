...
-c:s srt -map a -map 1:0 -ss 00:00:00 -to 00:00:10 "SAIDA"
"""
...
caminho_origem = r'C:\Users\G&M\Downloads\The.Good.Doctor.S05E01-07.720p.WEB-DL.DUAL'
caminho_destino = r'C:\Users\G&M\Downloads\serie2'
...
for raiz, pastas, arquivos in os.walk(caminho_origem):
    for arquivo in arquivos:
        ...
        comando = f'{comando_ffmpeg} -i "{caminho_completo}" {input_legenda} {codec_video} {crf} {preset} {codec_audio}' \
                  f' {bitrate_audio} {debug} {map_legenda} "{arquivo_saida}"'
